...
{
	{
		...
		intptr_t L_0 = Native_GetCurrentHolographicRenderFrame_m0E6DE189ECA50AF884CFF40CF8FA181EADB781B7(/*hidden argument*/NULL);
		return (intptr_t)L_0;
	}
}
...
{
	{
		...
		intptr_t L_0 = Native_GetCurrentHolographicSimulationFrame_mDEEDB499DF8C52A7A8A78C7E622684AA2DE0EB74(/*hidden argument*/NULL);
		return (intptr_t)L_0;
	}
}
#ifdef __clang__
